...
export const RES_MSG = {
  ...
  NOT_ALLOWED_SCENARIO_GROUP_TYPE: 'It is not allowed to add more scenario groups of this type to the population.',
  ...
  SAME_NAME_SCENARIO_GROUP: 'There is already a scenario group with the given name in the population.',
